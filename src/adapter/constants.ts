...
export const FOOTNOTE_BUTTON_ID = 'data-footnote-button-id'
export const FOOTNOTE_MAX_HEIGHT = 'data-footnote-max-height'
export const FOOTNOTE_POPOVER_ID = 'data-footnote-popover-id'
export const POPOVER_POSITION = 'data-footnote-position'
