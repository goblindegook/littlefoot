...
test('setup with custom buttonTemplate', t => {
  ...
  t.equal(
    buttons[0].getAttribute('data-reference'),
    'fnref:1',
    'replaces reference token'
  )
  t.ok(
    /This is footnote 1/.test(buttons[0].getAttribute('data-content')),
    'replaces content token'
  )
